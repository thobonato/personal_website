...
const Description = () => {
    return (
        <div className="max-w-5xl mx-auto text-l pt-6">
            <p className="py-2">👋 Hi! I'm Thomaz -- an engineer, researcher, and AI enthusiast. Originally from Brazil 🇧🇷, I've lived across Australia 🇦🇺, Costa Rica 🇨🇷, and the US 🇺🇸. I am currently studying Artificial Intelligence for Business at USC (Fight On ✌️) in Los Angeles, where I help lead the university's flagship startup incubator, supporting 10+ companies.</p>
            <p className="py-2">My journey with tech began at 13 when I built Clevr LMS. Since then, I've fallen in love with hacking away at problems and working on projects from eco-friendly AI to NLP to algorithms.</p>
